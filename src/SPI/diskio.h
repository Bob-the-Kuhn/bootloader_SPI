...
#define disk_initialize  USER_SPI_initialize
#define disk_status      USER_SPI_status
#define disk_read        USER_SPI_read
#define disk_write       USER_SPI_write
#define disk_ioctl       USER_SPI_ioctl

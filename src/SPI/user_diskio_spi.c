...
#define CS_HIGH()	{HAL_GPIO_WritePin(SD_SS_PIN_GPIO_Port, SD_SS_PIN_Pin, GPIO_PIN_SET);}
#define CS_LOW()	{HAL_GPIO_WritePin(SD_SS_PIN_GPIO_Port, SD_SS_PIN_Pin, GPIO_PIN_RESET);}

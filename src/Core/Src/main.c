...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, SDSS_Pin|SD_SCK_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : Detect_SDIO_Pin SD_MISO_Pin */
  GPIO_InitStruct.Pin = Detect_SDIO_Pin|SD_MISO_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : SDSS_Pin SD_SCK_Pin */
  GPIO_InitStruct.Pin = SDSS_Pin|SD_SCK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);
